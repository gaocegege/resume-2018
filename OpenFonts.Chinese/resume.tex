...
\begin{itemize}
    \item Ce Gao, Ren Rui, Hongming Cai. GAI: A Centralized Tree-Based Scheduler for Machine Learning Workload in Large Shared Clusters. In International Conference on Algorithms and Architectures for Parallel Processing (ICA3PP), 2018.
\end{itemize}
\sectionsep
