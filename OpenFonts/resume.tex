...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\namesection{Gao}{Ce}{ \urlstyle{same}\href{mailto:ce.gao@outlook.com}{ce.gao@outlook.com} | 1592 1592 066
}
...
\location{2017.10}
\begin{tightemize}
    \item Implemented a Minecraft server to play TiDB in Minecraft
    \item Won the \textbf{second \& special prize} in \href{http://gohack2017.golangfoundation.org/}{Go Hack 17}
    \end{tightemize}
\sectionsep
...
\href{https://github.com/weijianwen/SJTUThesis/commits?author=gaocegege}{weijianwen/SJTUThesis} & Add English abstract for the template; \\
